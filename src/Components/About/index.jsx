      ...
      <div className="container max-w-[1260px] mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-center">
          <div className="md:w-1/2 text-black px-6  md:text-left">
            ...
            <button className="bg-black text-white hover:bg-white hover:text-black px-6 py-3 rounded-lg shadow-lg font-semibold text-lg hover:scale-105 transition-transform">
              LEAREN MORE
            </button>
            </a>
          </div>
